                                    ...
                                    <div class="cat-navigation flexitem">
                                        ...
                                        <div class="item-sortir">
                                            <div class="label" onclick="toggleDropdown()">
                                                <span style="width:120px" class="mobile-hide">Sắp xếp</span>
                                        ...
                                        <script>
                                            ...
                                            function changeSorting(sortType) {
                                                // Chuyển hướng đến route mới khi thay đổi sắp xếp
                                                window.location.href = "http://127.0.0.1:8000/category/{{$category->id_category}}/sort/" + sortType;
...
{{--                                <a href="#" class="secondary-button"> Trang tiếp</a>--}}
